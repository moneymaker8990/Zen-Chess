...
function generateRemainingVijnanaEntries(): DailyEntry[] {
  ...
  for (const d of dayData) {
    entries.push({
      ...
      taoRef: { source: 'TAO', ref: `Tao-${String(((d.day - 1) % 81) + 1).padStart(2, '0')}` },
      artOfWarRef: { source: 'ART_OF_WAR', ref: `AoW-${Math.floor((d.day - 1) / 10) + 1}.${((d.day - 1) % 5) + 1}` },
      traditionContext: {
        vijnana: 'A medieval Kashmiri text offering 112 gateways into presence through breath, sensation, and immediacy.',
        tao: 'An ancient Chinese classic pointing to effortless harmony and the wisdom of yielding.',
        artOfWar: 'A classical treatise where outer strategy mirrors inner clarity.',
      },
  ...
  for (const t of themes) {
    entries.push({
      ...
      taoRef: { source: 'TAO', ref: `Tao-${String(((t.day - 1) % 81) + 1).padStart(2, '0')}` },
      artOfWarRef: { source: 'ART_OF_WAR', ref: `AoW-${Math.floor((t.day - 1) / 10) + 1}.${((t.day - 1) % 5) + 1}` },
      traditionContext: {
        vijnana: 'A medieval Kashmiri text offering 112 gateways into presence through breath, sensation, and immediacy.',
        tao: 'An ancient Chinese classic pointing to effortless harmony and the wisdom of yielding.',
        artOfWar: 'A classical treatise where outer strategy mirrors inner clarity.',
      },
      vijnanaText: `Verse ${t.day} points to ${t.focus}. Let awareness rest there.`,
      ...
      taoText: 'The Tao that can be lived is the true Tao.',
      taoCommentary: 'Each day\'s practice is not philosophy but lived experience. Let the teaching move from head to body to being.',
      artOfWarText: 'Know the ground on which you stand.',
      artOfWarCommentary: 'Awareness is your ground. From here, all action becomes appropriate.',
