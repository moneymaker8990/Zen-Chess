...
const morePawnStructureVariations: CourseVariation[] = [
  { id: 'ps-61', title: 'Sicilian Maroczy Bind', fen: 'r1bqkb1r/pp1ppp1p/2n3pn/8/2P1P3/2N5/PP2BPPP/R1BQK1NR w KQkq - 0 6', toMove: 'white', concept: 'Bind with c4+e4', keyTakeaway: 'c4+e4 creates lasting space.', difficulty: 4, moves: [{ move: 'Nf3', annotation: '!', explanation: 'Completing development in the bind!' }] },{ id: 'ps-63', title: 'Benoni Dynamic Play', fen: 'r1bqkb1r/pp1p1ppp/2n1pn2/2pP4/4P3/2N5/PPP2PPP/R1BQKBNR w KQkq - 0 5', toMove: 'white', concept: 'Benoni central control', keyTakeaway: 'Space advantage in the Benoni.', difficulty: 4, moves: [{ move: 'Nf3', annotation: '!', explanation: 'Developing!' }] },
  // Continue for more...
];
...
// ============================================
const moreOpenFileVariations: CourseVariation[] = [// Continue for 37 more...
];
...
const pieceActivityVariations: CourseVariation[] = [
  { id: 'act-1', title: 'Active vs Passive', fen: 'r1bqkb1r/pppp1ppp/2n2n2/4p3/2B1P3/5N2/PPPP1PPP/RNBQK2R w KQkq - 0 4', toMove: 'white', concept: 'Activity is key', keyTakeaway: 'Active pieces win games.', difficulty: 2, moves: [{ move: 'Nc3', annotation: '!', explanation: 'Active development!' }] },{ id: 'act-3', title: 'Piece Placement', fen: 'r1bqkb1r/pppp1ppp/2n2n2/4p3/2B1P3/5N2/PPPP1PPP/RNBQK2R w KQkq - 0 4', toMove: 'white', concept: 'Best squares for pieces', keyTakeaway: 'Every piece has a best square.', difficulty: 2, moves: [{ move: 'd3', annotation: '!', explanation: 'Solid placement!' }] },
...
const kingSafetyVariations: CourseVariation[] = [
  ...
  { id: 'ks-4', title: 'King in Center Attack', fen: 'r1bqkb1r/pppp1ppp/2n2n2/4p3/2B1P3/2N2N2/PPPP1PPP/R1BQK2R w KQkq - 0 5', toMove: 'white', concept: 'Attack uncastled king', keyTakeaway: 'Attack the center-stuck king.', difficulty: 3, moves: [{ move: 'd4', annotation: '!', explanation: 'Opening the center!' }] },// Continue for 45 more...
];
