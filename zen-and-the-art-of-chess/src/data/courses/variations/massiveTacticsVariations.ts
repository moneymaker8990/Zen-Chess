...
export const allPinVariations: CourseVariation[] = [
  // Basic Pins (1-20)
  { id: 'pin-b1', title: 'Pin to King #1', fen: 'r1bqk2r/pppp1ppp/2n2n2/4p3/1bB1P3/2N2N2/PPPP1PPP/R1BQK2R w KQkq - 0 5', toMove: 'white', concept: 'Absolute pin basics', keyTakeaway: 'The bishop cannot move - it would expose the king.', difficulty: 1, moves: [{ move: 'O-O', explanation: 'Castling to safety, the pin on c3 is harmless.' }] }{ id: 'pin-b3', title: 'Pin to King #3', fen: 'r1bqkbnr/pppp1ppp/2n5/4p3/2B1P3/5N2/PPPP1PPP/RNBQK2R w KQkq - 0 4', toMove: 'white', concept: 'Pin setup', keyTakeaway: 'Position bishops on open diagonals.', difficulty: 1, moves: [{ move: 'Nc3', explanation: 'Developing with central control.' }] }{ id: 'pin-b6', title: 'Pin to Rook #1', fen: 'r1bqkb1r/pppp1ppp/2n2n2/4p3/2B1P3/5N2/PPPP1PPP/RNBQK2R w KQkq - 0 4', toMove: 'white', concept: 'Pin to the rook', keyTakeaway: 'Pins to rooks can win material.', difficulty: 2, moves: [{ move: 'd3', explanation: 'Solid development.' }] },
  { id: 'pin-b7', title: 'Breaking a Pin #1', fen: 'r1bqk2r/pppp1ppp/2n2n2/4p3/1bB1P3/2N2N2/PPPP1PPP/R1BQK2R w KQkq - 0 5', toMove: 'white', concept: 'Escaping pins', keyTakeaway: 'Break pins with counterattacks.', difficulty: 2, moves: [{ move: 'a3', annotation: '!', explanation: 'Asking the bishop where it wants to go.' }] }{ id: 'pin-b9', title: 'Exploiting Pin #1', fen: 'r1bqkb1r/pppp1ppp/2n5/4p2n/2B1P3/2N2N2/PPPP1PPP/R1BQK2R w KQkq - 0 5', toMove: 'white', concept: 'Attack pinned pieces', keyTakeaway: 'Add attackers to pinned pieces.', difficulty: 2, moves: [{ move: 'd4', annotation: '!', explanation: 'Attacking the pinned center.' }] },{ id: 'pin-b11', title: 'Pin and Win #1', fen: 'r2qkb1r/ppp2ppp/2n1bn2/3pp3/2B1P3/2N2N2/PPPP1PPP/R1BQK2R w KQkq - 0 6', toMove: 'white', concept: 'Win material with pin', keyTakeaway: 'Pins can win pawns and pieces.', difficulty: 3, moves: [{ move: 'exd5', annotation: '!', explanation: 'Winning the pawn!' }] },
  ...
  { id: 'pin-b13', title: 'Double Pin #1', fen: 'r1bqk2r/pppp1ppp/2n2n2/4p3/1bB1P3/2NP1N2/PPP2PPP/R1BQK2R w KQkq - 0 5', toMove: 'white', concept: 'Creating multiple pins', keyTakeaway: 'Multiple pins overwhelm defense.', difficulty: 4, moves: [{ move: 'Bg5', annotation: '!', explanation: 'Now two pieces are pinned!' }] },{ id: 'pin-b15', title: 'Skewer #1', fen: '4k3/8/8/8/8/8/4R3/4K3 w - - 0 1', toMove: 'white', concept: 'Basic skewer', keyTakeaway: 'Skewer is a reverse pin.', difficulty: 2, moves: [{ move: 'Re8+', annotation: '!', explanation: 'Skewering the king!' }] },
  ...
  { id: 'pin-i1', title: 'Legal Trap', fen: 'r1bqkb1r/pppp1ppp/2n2n2/4p2Q/2B1P3/8/PPPP1PPP/RNB1K1NR w KQkq - 0 4', toMove: 'white', concept: 'Famous pin trap', keyTakeaway: 'The Legal Trap wins the queen.', difficulty: 3, moves: [{ move: 'Nc3', annotation: '!', explanation: 'Setting up the trap!' }] },{ id: 'pin-i3', title: 'Pin and Discovery', fen: 'r1bqkb1r/pppp1ppp/2n2n2/4p3/2B1P3/5N2/PPPP1PPP/RNBQK2R w KQkq - 0 4', toMove: 'white', concept: 'Pin enables discovery', keyTakeaway: 'Pins enable discovered attacks.', difficulty: 4, moves: [{ move: 'Ng5', annotation: '!', explanation: 'Threatening discovered attack on f7!' }] },{ id: 'pin-i5', title: 'Absolute Pin Exploitation', fen: 'r1bqk2r/pppp1ppp/2n5/4p2n/1bB1P3/2N2N2/PPPP1PPP/R1BQK2R w KQkq - 0 5', toMove: 'white', concept: 'Exploit absolute pins', keyTakeaway: 'Absolute pins are permanent targets.', difficulty: 3, moves: [{ move: 'Nxe5', annotation: '!', explanation: 'Taking the pinned pawn!' }] },{ id: 'pin-i9', title: 'Cross Pin', fen: 'r1bqk2r/pppp1ppp/2n2n2/4p3/1bB1P3/2NP1N2/PPP2PPP/R1BQK2R w KQkq - 0 5', toMove: 'white', concept: 'Crossing pins', keyTakeaway: 'Create intersecting pins.', difficulty: 4, moves: [{ move: 'Bg5', annotation: '!', explanation: 'Cross-pinning!' }] },
  { id: 'pin-i10', title: 'Pin Breakthrough', fen: 'r1bqkb1r/pppp1ppp/2n2n2/4p3/2B1P3/2N2N2/PPPP1PPP/R1BQK2R w KQkq - 0 5', toMove: 'white', concept: 'Breaking through the pin', keyTakeaway: 'Use pins to break through.', difficulty: 4, moves: [{ move: 'd4', annotation: '!', explanation: 'Breaking through!' }] },{ id: 'pin-i12', title: 'Pin on Open File', fen: 'r1bqk2r/pppp1ppp/2n2n2/4p3/2B1P3/2N2N2/PPPP1PPP/R1BQR1K1 w kq - 0 6', toMove: 'white', concept: 'Rook pin on file', keyTakeaway: 'Rooks pin on open files.', difficulty: 3, moves: [{ move: 'd4', annotation: '!', explanation: 'Opening the center!' }] },
  ...
  { id: 'pin-i15', title: 'Defensive Pin #1', fen: 'r1bqkb1r/pppp1ppp/2n2n2/4p3/2B1P3/2N2N2/PPPP1PPP/R1BQK2R b KQkq - 0 5', toMove: 'black', concept: 'Pin for defense', keyTakeaway: 'Use pins defensively.', difficulty: 3, moves: [{ move: 'Bb4', annotation: '!', explanation: 'Pinning the knight!' }] },{ id: 'pin-i18', title: 'Unpinning Tactic', fen: 'r1bqk2r/pppp1ppp/2n2n2/4p1B1/1bB1P3/2N2N2/PPPP1PPP/R2QK2R b KQkq - 0 5', toMove: 'black', concept: 'Breaking free', keyTakeaway: 'Find tactical ways to unpin.', difficulty: 4, moves: [{ move: 'Bxc3+', annotation: '!', explanation: 'Unpinning with tempo!' }] },{ id: 'pin-i20', title: 'Pin and Centralization', fen: 'r1bqkb1r/pppp1ppp/2n2n2/4p3/2B1P3/2N2N2/PPPP1PPP/R1BQK2R w KQkq - 0 5', toMove: 'white', concept: 'Centralize with pins', keyTakeaway: 'Use pins to centralize pieces.', difficulty: 3, moves: [{ move: 'd3', annotation: '!', explanation: 'Central control!' }] },
  // Advanced Pins (51-80)
  ...
  { id: 'pin-a4', title: 'Pin Calculation #2', fen: 'r1bqkb1r/pppp1ppp/2n2n2/4p3/2B1P3/2N2N2/PPPP1PPP/R1BQK2R w KQkq - 0 5', toMove: 'white', concept: 'Deep pin calculation', keyTakeaway: 'See several moves ahead.', difficulty: 5, moves: [{ move: 'd4', annotation: '!', explanation: 'Opening lines!' }] },{ id: 'pin-a6', title: 'Pin Combination #2', fen: 'r1bqkb1r/pppp1ppp/2n2n2/4p2Q/2B1P3/2N5/PPPP1PPP/R1B1K1NR w KQkq - 0 4', toMove: 'white', concept: 'Mating pin combo', keyTakeaway: 'Pins can lead to mate.', difficulty: 5, moves: [{ move: 'Nf3', annotation: '!', explanation: 'Developing with threats!' }] },
...
export const allForkVariations: CourseVariation[] = [
  // Knight Forks (1-40){ id: 'fork-n5', title: 'Knight Fork Setup #2', fen: 'r1bqkb1r/pppp1ppp/2n2n2/4p3/2B1P3/2N2N2/PPPP1PPP/R1BQK2R w KQkq - 0 5', toMove: 'white', concept: 'Prepare the fork', keyTakeaway: 'Preparation is key to forks.', difficulty: 2, moves: [{ move: 'Ng5', annotation: '!', explanation: 'Setting up!' }] },
  ...
  { id: 'fork-n18', title: 'Fork Combination #2', fen: 'r1bqk2r/pppp1ppp/2n2n2/4p3/2B1P3/2N2N2/PPPP1PPP/R1BQK2R w KQkq - 0 5', toMove: 'white', concept: 'Setup combination', keyTakeaway: 'Build up to the fork.', difficulty: 4, moves: [{ move: 'Ng5', annotation: '!', explanation: 'The setup!' }] },// More knight forks (21-40)
  ...
  { id: 'fork-q1', title: 'Queen Fork #1', fen: 'r1b1kb1r/pppp1ppp/2n2n2/4p3/2B1P2q/2N2N2/PPPP1PPP/R1BQK2R w KQkq - 0 5', toMove: 'white', concept: 'Queen double attack', keyTakeaway: 'Queens fork on diagonals and files.', difficulty: 2, moves: [{ move: 'Nxe5', annotation: '!', explanation: 'Fork!' }] },{ id: 'fork-q5', title: 'Queen Fork #5', fen: 'r1bqkb1r/pppp1ppp/2n2n2/4p2Q/2B1P3/8/PPPP1PPP/RNB1K1NR w KQkq - 0 4', toMove: 'white', concept: 'Scholar\'s Mate threat', keyTakeaway: 'The classic fork threat.', difficulty: 1, moves: [{ move: 'Qxf7#', annotation: '!!', explanation: 'Checkmate!' }] },
  { id: 'fork-b1', title: 'Bishop Fork #1', fen: '4k3/8/8/8/1n3n2/8/3B4/4K3 w - - 0 1', toMove: 'white', concept: 'Bishop forks two knights', keyTakeaway: 'Bishops fork on diagonals.', difficulty: 2, moves: [{ move: 'Bc3', annotation: '!', explanation: 'Fork!' }] },{ id: 'fork-r2', title: 'Rook Fork #2', fen: '4k3/8/8/8/b7/8/4R3/4K2n w - - 0 1', toMove: 'white', concept: 'Rook on file', keyTakeaway: 'Files are powerful.', difficulty: 2, moves: [{ move: 'Ra2', annotation: '!', explanation: 'Fork!' }] },
...
export const allCheckmateVariations: CourseVariation[] = [
  ...
  // Smothered Mate (21-35){ id: 'mate-sm2', title: 'Smothered Setup', fen: '6k1/5ppp/8/5N2/8/8/8/4R1K1 w - - 0 1', toMove: 'white', concept: 'Setup the smother', keyTakeaway: 'Force pieces to smother.', difficulty: 4, moves: [{ move: 'Ne7+', annotation: '!', explanation: 'Setup!' }] },
  ...
  // More patterns...{ id: 'mate-ep1', title: 'Epaulette Mate', fen: '3rkr2/8/8/8/8/8/8/4Q1K1 w - - 0 1', toMove: 'white', concept: 'Rooks block king', keyTakeaway: 'King has epaulettes.', difficulty: 3, moves: [{ move: 'Qe6#', annotation: '!!', explanation: 'Epaulette!' }] }
];
...
// ============================================
export const interferenceVariations: CourseVariation[] = [// More...
];
