...
const expandedKingPawnVariations: CourseVariation[] = [
  ...
  { id: 'ekp-1', title: 'Direct Opposition', fen: '4k3/8/4K3/4P3/8/8/8/8 w - - 0 1', toMove: 'white', concept: 'Kings face to face', keyTakeaway: 'With the opposition, you control the position.', difficulty: 2, moves: [{ move: 'Kd6', annotation: '?', explanation: 'Losing the opposition!' }] }{ id: 'ekp-3', title: 'Distant Opposition', fen: '4k3/8/8/8/8/8/8/4K3 w - - 0 1', toMove: 'white', concept: 'Opposition over distance', keyTakeaway: 'Maintain odd number of squares.', difficulty: 3, moves: [{ move: 'Ke2', annotation: '!', explanation: 'Distant opposition!' }] },
