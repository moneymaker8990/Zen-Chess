...
export const pawnStructureVariations: CourseVariation[] = [
  // CARLSBAD STRUCTURE (1-10)
  {
    ...
    keyTakeaway: 'White plays b4-b5 to create queenside weaknesses.',
    difficulty: 4,
    moves: [
      { move: 'a3', annotation: '!', explanation: 'Preparing b4 to start the minority attack.', arrows: [{ from: 'b2', to: 'b4', color: 'yellow' }] },
      { move: 'O-O', explanation: 'Black castles.' },
      { move: 'b4', annotation: '!', explanation: 'The minority attack begins!', arrows: [{ from: 'b4', to: 'b5', color: 'yellow' }] },
      { move: 'cxb4', explanation: 'Black captures.' },
      { move: 'axb4', explanation: 'Opening the a-file.' },
      { move: 'Bd7', explanation: 'Black develops.' },
      { move: 'b5', annotation: '!', explanation: 'Breaking through! The c6 pawn will become weak.', highlights: ['c6'] },
    ]
  },
  {
    id: 'ps-2',
