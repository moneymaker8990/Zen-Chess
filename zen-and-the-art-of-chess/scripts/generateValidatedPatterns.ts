...
function generateKnightPlacementPatterns(): EnhancedPattern[] {
  ...
  // Pattern 4: Knight on Outpost Square
  patterns.push({
  ...
  // Pattern 7: Knight Defending Key Squares
  patterns.push({
  ...
  // Pattern 8: Knight on Central Square
  patterns.push({
...
function generateCentralizationPatterns(): EnhancedPattern[] {
  ...
  // Pattern 6: Centralizing the Queen
  patterns.push({
  ...
  // Pattern 7: Centralizing All Pieces
  patterns.push({
...
function generateKingActivityPatterns(): EnhancedPattern[] {
  ...
  // Pattern 4: King Supporting Pawns
  patterns.push({
  ...
  // Pattern 6: King Activity in Middlegame
  patterns.push({
...
function generateBlockadePatterns(): EnhancedPattern[] {
  ...
  // Pattern 4: Blockading Doubled Pawns
  patterns.push({
  ...
  // Pattern 6: Blockading Weak Pawn Chains
  patterns.push({
  ...
  // Pattern 7: Blockading with Bishop
  patterns.push({
  ...
  // Pattern 8: Blockading with Rook
  patterns.push({
...
function generateExchangeStrategyPatterns(): EnhancedPattern[] {
  ...
  // Pattern 4: Exchanging to Reach Endgame
  patterns.push({
  ...
  // Pattern 6: Exchanging to Remove Threats
  patterns.push({
  ...
  // Pattern 7: Exchanging to Win Material
  patterns.push({
  ...
  // Pattern 8: Exchanging to Improve Position
  patterns.push({
...
function generatePieceCoordinationPatterns(): EnhancedPattern[] {
  ...
  // Pattern 5: Coordinating All Pieces
  patterns.push({
  ...
  // Pattern 7: Coordinating Queen and Bishop
  patterns.push({
  ...
  // Pattern 8: Coordinating Queen and Knight
  patterns.push({
  ...
  // Pattern 9: Coordinating Rooks and Knights
  patterns.push({
...
async function generateAndValidatePatterns() {
  console.log('🎯 Starting AI-Assisted Pattern Generation - Batch 14\n');
  ...
  console.log('Note: Batch 14 - Adding 9th patterns to categories with 8 patterns.');
  console.log('Focus: BLOCKADE, CENTRALIZATION, EXCHANGE_STRATEGY, KING_ACTIVITY, KNIGHT_PLACEMENT, PAWN_BREAKS, PIECE_COORDINATION\n');
